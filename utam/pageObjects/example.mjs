...
async function _utam_get_auraErrorTitleContent(driver, root) {
    let _element = await _utam_get_auraError(driver, root);
    const _locator = _By.css("span#auraErrorTitle");
    return _element.findElement(_locator);
}

async function _utam_get_auraErrorMessageContent(driver, root) {
    let _element = await _utam_get_auraError(driver, root);
    const _locator = _By.css("div#auraErrorMessage");
    return _element.findElement(_locator);
}

async function _utam_get_auraErrorReload(driver, root) {
    let _element = await _utam_get_auraError(driver, root);
    const _locator = _By.css("a#auraErrorReload");
    return _element.findElement(_locator);
}

async function _utam_get_iconstage(driver, root) {
    let _element = root;
    const _locator = _By.css("div#iconstage");
    return _element.findElement(_locator);
}
...
async function _utam_get_list1(driver, root) {
    let _element = await _utam_get_header(driver, root);
    const _locator = _By.css("ul:nth-of-type(2)");
    return _element.findElement(_locator);
}
...
export default class Example extends _UtamBaseRootPageObject {
    constructor(driver, element, locator = _By.css("html")) {
    ...
    async getInput() {
        const driver = this.driver;
        const root = await this.getRootElement();
        const ActionableClickableEditableUtamElement = _createUtamMixinCtor(_ActionableUtamElement, _ClickableUtamElement, _EditableUtamElement);
